		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `[ ⚠️NÃO REGISTRO⚠]\n\n️ SALVE *${pushname2}* Vocês ainda não são amigos *${name}* \nRegistre-se primeiro Para ter acesso ao menu\n\n haha ${prefix}daftar Bruxinho/19`,
        ...
        const limitAdd = (sender) => {
            ...
            if (args.match(/(https:\/\/chat.whatsapp.com)/gi)) {
                ...
                if (!check) {
                    ...
                    reply('*[LINK DE GRUPO DETECTADO!]*\nVOU YE REMOVER DO GRUPO SEU FDP DA PRÓXIMA VEZ PRESTE ATENÇÃO NAS REGRAS.').then(() => {
                        client.groupRemove()
                    })
                }
            }
		...
		case 'daftar':
			...
			case 'fadhil':
                ...
                setTimeout( () => {
					...
					setTimeout( () => {*/
					client.sendMessage(from, 'Obrigado por usar o*ARR157-BOT* \n\n*\nSe inscreva da uma força no meu canal Man https://https://youtube.com/channel/UCalQOjX5BFqim6x8JyCMM-w', text, {quoted: mek})
					}, 0)
    				break
/*********PISAH MENU**********/
              case 'ownermenu':
